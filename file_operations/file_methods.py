...
import os                           # Access file and folders properties and perform different functions
import shutil                       # To perform file related operations
...
class File_Operation:
    ...
    def __init__(self, file_object, logger_object):
        self.file_object = file_object              # file to log messages
        self.logger_object = logger_object          # object for logging
        self.model_directory = 'models/'              # path to save models
    ...
    def save_model(self,model,filename):
        ...
        try:
            ...
            if os.path.isdir(path):                           # remove previously existing models for each clusters
                ...
                os.makedirs(path)                  # if no pervious models exist make a directory to store models
    ...
    def load_model(self, filename):
        ...
        try:
            with open(self.model_directory + filename + '/' + filename + '.sav', 'rb') as f:
                ...
                return pickle.load(f)           # load the model for prediction
        except Exception as e:
            self.logger_object.log(self.file_object,
