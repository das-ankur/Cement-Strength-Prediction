...
from sklearn.linear_model import LinearRegression       # For linear Regressor
...
class Model_Finder:
    ...
    def __init__(self, file_object, logger_object):
        """
        Constructor:
        file_object: file to log messages
        logger_object: object for logging
        """
        self.file_object = file_object                      # Initialize file_object
        self.logger_object = logger_object                  # Initialize logger_object
        self.linearReg = LinearRegression()                 # Create Linear Regressor
        self.RandomForestReg = RandomForestRegressor()      # Create Random Forest Regressor
