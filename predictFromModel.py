...
class prediction:
    """
    The class is used to predict the output of the given files  by the webpage
    """
    def __init__(self,path):
        """
        Description: constructor
        """
        self.file_object = open("Prediction_Logs/Prediction_Log.txt", 'a+')     # files to log messages
        self.log_writer = logger.App_Logger()                                   # object for logging
        self.pred_data_val = Prediction_Data_validation(path)                   # object for validation
