...
from kneed import KneeLocator                       # for finding  optimal number of clusters
...
class KMeansClustering:
    ...
    def __init__(self, file_object, logger_object):
        ...
        file_object: file to store log messages
    ...
    def elbow_plot(self,data):
        ...
        try:
            ...
            self.kn = KneeLocator(range(1, 11), wcss, curve='convex', direction='decreasing') #Finding optimal number of clusters
            ...
            return self.kn.knee         # return optimal  number of clusters
    ...
    def create_clusters(self, data, number_of_clusters):
        ...
        self.data=data              # data needs to be clustered
        try:
