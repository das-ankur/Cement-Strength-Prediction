import pandas as pd
import numpy as np
from sklearn.impute import KNNImputer                   # for imputing missing values suing K-Nearest Neighbour algorithm
...
class Preprocessor:
    ...
    def remove_columns(self, data, columns):
        ...
        self.data = data                # data to  be processed
        self.columns = columns          # columns to be removed
        try:
